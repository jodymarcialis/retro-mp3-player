...
root.title('Music Player - Castlevania Harmony of Dissonance OST mix')
root.resizable(0, 0)
...
button_frame = LabelFrame(root, text='Control Buttons', bg='grey', width=400, height=120)
...
# SongFrame Labels
Label(song_frame, text='CURRENTLY PLAYING:', bg='grey', font=('Times', 10, 'bold')).place(x=5, y=20)
...
pause_btn = Button(button_frame, text='Pause', bg='Goldenrod', font=("Georgia", 13), width=7,
                    command=lambda: pause_song(song_status))
pause_btn.place(x=15, y=10)

stop_btn = Button(button_frame, text='Stop', bg='Goldenrod', font=("Georgia", 13), width=7,
                  command=lambda: stop_song(song_status))
stop_btn.place(x=105, y=10)

play_btn = Button(button_frame, text='Play', bg='Goldenrod', font=("Georgia", 13), width=7,
                  command=lambda: play_song(current_song, playlist, song_status))
play_btn.place(x=195, y=10)

resume_btn = Button(button_frame, text='Resume', bg='Goldenrod', font=("Georgia", 13), width=7,
                    command=lambda: resume_song(song_status))
resume_btn.place(x=285, y=10)

load_btn = Button(button_frame, text='Load Directory', bg='Goldenrod', font=("Georgia", 13), width=35, command=lambda: load(playlist))
